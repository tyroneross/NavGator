...
Pattern borrowed from the benchmark repo's trigger spec testing approach but
...
EXPECTED_TRIGGERS: list[tuple[str, str]] = [
    # architecture-scan — scanning
    ("architecture-scan", "architecture"),
    ("architecture-scan", "scan"),
    ...
    # navgator-setup — install/setup
    ("navgator-setup", "install"),

    # architecture-export — diagrams
    ("architecture-export", "diagram"),
]
