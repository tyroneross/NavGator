 ...
 */
export async function scanStoryboards(projectRoot) {
    const components = [];
    const connections = [];
    ...
    const viewControllerMap = new Map();
    ...
    for (const file of storyboardFiles) {
        ...
        for (const segue of segues) {
            ...
            if (sourceVc && destVc) {
                const connection = createSegueConnection(sourceVc, destVc, segue, timestamp);
 ...
 */
function extractViewControllers(content, file) {
 ...
 */
function extractSegues(content, file) {
    const segues = [];
 ...
 */
function createViewControllerComponent(vc, timestamp) {
 ...
 */
function createSegueConnection(source, dest, segue, timestamp) {
...
//# sourceMappingURL=storyboard-scanner.js.map