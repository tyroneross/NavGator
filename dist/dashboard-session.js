...
export function dashboardSessionPath() {
 ...
 */
export function mintBootstrapNonce() {
    return crypto.randomBytes(32).toString('hex');
}
/**
 ...
 */
export function writeDashboardSession(token, port) {
...
function isDashboardSessionRecord(value) {
