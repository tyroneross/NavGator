...
describe('subgraph', () => {
    ...
    const mockConnections = [
        ...
        createMockConnection('comp-1', 'comp-3', { connection_id: 'conn-2', confidence: 0.8, semantic: { classification: 'api-call', confidence: 0.8 } }),
        createMockConnection('comp-4', 'comp-1', { connection_id: 'conn-3', confidence: 0.9, semantic: { classification: 'http-request', confidence: 0.8 } }),
        createMockConnection('comp-1', 'comp-5', { connection_id: 'conn-4', confidence: 0.7, semantic: { classification: 'service-call', confidence: 0.8 } }),
