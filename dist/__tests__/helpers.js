 ...
 */
export function createMockConnection(fromComponentId, toComponentId, overrides = {}) {
 ...
 */
export function createComponent(nameOrOpts, roleOverrides) {
    ...
    if (file) {
        overrides.source = { detection_method: 'auto', config_files: [file], confidence: 0.9 };
    }
    return createMockComponent(overrides);
}
/**
 ...
 */
export function createConnection(from, to, overrides) {
 ...
 */
export function createMockGraph(components, connections) {
    return {
