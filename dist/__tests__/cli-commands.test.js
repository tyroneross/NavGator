...
describe('CLI command modules', () => {
    ...
    it('all 17 commands register on a single program without collisions', async () => {
        const [{ registerScanCommand }, { registerStatusCommand }, { registerImpactCommand }, { registerConnectionsCommand }, { registerListCommand }, { registerDiagramCommand }, { registerPromptsCommand }, { registerTraceCommand }, { registerRulesCommand }, { registerCoverageCommand }, { registerSubgraphCommand }, { registerSetupCommand, registerUICommand, registerHistoryCommand, registerDiffCommand, registerProjectsCommand, registerSummaryCommand, },] = await Promise.all([
