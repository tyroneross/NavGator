...
const MAX_DEPTH = 3;
export function discoverRepos(dir, opts = {}) {
...
function walk(dir, remainingDepth, out) {
    let entries;
    try {
...
function statGit(repoCandidate) {
    ...
    if (gitStat.isDirectory())
        return { present: true, isFile: false };
    if (gitStat.isFile())
        return { present: true, isFile: true };
    return { present: false, isFile: false };
}
