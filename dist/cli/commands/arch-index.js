...
import { ARCHITECTURE_INDEX_PATH, ARCHITECTURE_MD_PATH, buildArchitectureIndex, stableStringify, writeArchitectureIndex, } from '../../architecture-index.js';
import { wrapInEnvelope } from '../../agent-output.js';
import { EXIT_CODES } from '../exit-codes.js';
export function registerArchIndexCommand(program) {
    program
        .command('arch-index')
        ...
        try {
            ...
            if (options.write) {
                ...
                console.log(`  coverage=${payload.coverage} files=${payload.analyzed_files} ` +
            ...
            if (options.check) {
                ...
                if (options.agent) {
                    ...
                    console.error(`Architecture index is stale: ${stale.join(', ')}\n` +
...
//# sourceMappingURL=arch-index.js.map