...
export function buildReport(runId, config, projectRoot) {
    ...
    const findingsByComponent = [...byComponent.values()].sort((a, b) => a.component_name.localeCompare(b.component_name) ||
