---
name: feedback
description: Report a bug or send feedback about the navgator plugin
---

# Report navgator feedback

File the user's report as a GitHub issue on `tyroneross/NavGator`. Issues are this plugin's
...
```bash
gh issue create --repo tyroneross/NavGator \
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/NavGator/issues/new
