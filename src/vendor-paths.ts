...
export const VENDOR_CONTAINER_SEGMENTS: readonly string[] = [
  'packages',
  'deps',
  'externals',
  'vendor',
...
export const EXTERNAL_PACKAGE_TYPES: readonly ComponentType[] = [
  'npm',
  'pip',
  'cargo',
  'spm',
...
export function hasVendorSegment(filePath: string): boolean {
 ...
 */
export function underPackageContainer(filePath: string, externalNames: Set<string>): boolean {
